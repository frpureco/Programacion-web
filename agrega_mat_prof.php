...
<div class="col-md-9 col-md-9">
	<div class="jumbotron">
		<div class="container">
			...
			<button class="btn btn-primary" id="mostrar">Mostrar</button>
		</div>
	</div>
</div>
</div>
<div class="row">
	<div class="col-md-4">
      <div class="panel panel-primary">
        ...
        <div class="col-md-1" ></div>
          ...
          <div class="form-group">
            <label for="nombre">Clave Materia</label>
            <div class="input-group">
              <span class="input-group-addon">?</span>
           ...
           <div class="form-group">
            ...
            <div class="input-group">
              ...
              <input type="text" class="form-control " id="anio"
                   placeholder="el año en el se imparte">
            </div>
          </div>                                                      
    ...
    <div class="col-md-4">
		<div class="panel panel-success">
			<div class="panel panel-heading">
				<label class="label label-success" style="font-size: 18px;"> profesores</label>						
			</div>
