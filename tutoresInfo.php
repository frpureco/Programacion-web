...
<html>
<head>
	<title>Información sobre los Tutores</title>
...
<div class="container-fluid">		
	...
	<div class="row">
			...
			<div class="col-md-9 col-md-9">
				<div class="jumbotron">
					<div class="container">
						<label style="font-size: 20px;" class="label label-primary "> Primero Busca el Tutor</label>
						<p><label>Esta sección es solo para ver Informacion relativa a un Tutor, para ello Basta con buscar un tutor; utilizando su Nombre, después aparecerá la informacion Correspondiente</label></p>
					</div>
				</div>
			</div>
		</div>
