...
<html>
<head>
	<title>Información sobre las materias</title>
...
<div class="container-fluid">		
					...
					<ul class="menu">
						<div class="row container-fluid" style="background-color: #eff5ba;">
							...
							<li>
									...
									Hola <?php echo $_SESSION['user']; ?> Bienvenido al área de Información de las materias
								</label>
							</li>							
							</div>
								<li>
	...
	<div class="row">
			...
			<div class="col-md-9 col-md-9">
				<div class="jumbotron">
					<div class="container">
						<label style="font-size: 20px;" class="label label-primary "> Primero Busca el la materia</label>
						<p><label>Esta sección es solo para ver Informacion relativa a las materias, para ello basta con buscar la materia; utilizando su clave, después aparecerá la informacion correspondiente</label></p>
					</div>
				</div>
			</div>
		</div>
	<div class="row ">
        ...
        <div class="input-group">
          <input type="text" name="matricula" class="form-control" id="matricula" placeholder="clave de la materia"> 
	...
	<div class="col-sm-5 col-md-3 container-fluid">
				<div class="thumbnail">
					...
					<div class="caption">
						<h3>Profesor que imparte esta clase:</h3>
