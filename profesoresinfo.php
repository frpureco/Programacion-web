...
<html>
<head>
	<title>Información sobre los Profesores</title>
...
<div class="container-fluid">		
					...
					<ul class="menu">
						<div class="row container-fluid" style="background-color: #eff5ba;">
							...
							<li>
									...
									Hola <?php echo $_SESSION['user']; ?> Bienvenido al área de Información de los Profesores
								</label>
							</li>							
							</div>
								<li>
	...
	<div class="row">
			...
			<div class="col-md-9 col-md-9">
				<div class="jumbotron">
					<div class="container">
						<label style="font-size: 20px;" class="label label-primary "> Primero Busca el Profesor</label>
						<p><label>Esta sección es solo para ver Informacion relativa a un Profesor, para ello Basta con buscar un Profesor; utilizando su Nombre, después aparecerá la informacion Correspondiente</label></p>
					</div>
				</div>
			</div>
		</div>
	<div class="row ">
        ...
        <div class="input-group">
          <input type="text" name="matricula" class="form-control" id="matricula" placeholder="Nombre del tutor"> 
        ...
        <div class="panel panel-heading">
			...
			<div class="col-sm-5 col-md-3 container-fluid">
				<div class="thumbnail">
					...
					<div class="caption">
						<h3>Tutor: Francisco Javier Pureco Lucas</h3>
						<p>RFC: 13940183</p>
						<p>Grupo a cargo: 103</p>
			...
			<div class="col-sm-5 col-md-3">
				<div class="panel panel-primary">
					<div class="panel panel-heading">
						<label class="label label-primary" style="font-size: 18px;"> Bimestres Calificados</label>
					</div>					
				</div>
			</div>
		</div>
